...
def run_plot(args):
    ...
    if metadata.get("purpose") != "residual_diagnostics":
        raise ValueError("residual diagnostic artifact required")
    products = plot_diagnostics(arrays, metadata, args.output_dir)
