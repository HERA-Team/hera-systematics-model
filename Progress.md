...
- Independently accepted rebound primary analyses for spectral windows 00 and 01. Job 12050618 in run `6a6479156ef4-0adc1429529b6493` completed with exit status 0:0 in 01:50:09. Job 12050670 in run `6a6479156ef4-0bbd8e73c1aff1fe` completed with exit status 0:0 in 01:24:42. Both checkers verified 1142 candidates, the accepted paired parent job 11985016, size-matched receipt products, and complete evaluation and descriptive artifacts. Compact evidence is `normalization-recovered-primary-00-terminal-acceptance.json` and `normalization-recovered-primary-01-terminal-acceptance.json`.
- Independently accepted rebound diagnostic products for spectral windows 00 and 01. Job 12118128 in run `6a6479156ef4-cbf26d03c1b3cc32` completed with exit status 0:0 in 00:01:58 and verified 4 receipt products plus 18 figures. Job 12118152 in run `6a6479156ef4-8f8f39d73f95aaa6` completed with exit status 0:0 in 00:01:46 and verified 4 receipt products plus 9 figures. Both checkers bound 1000 surrogates, seed 0, and size-matched products. Compact evidence is `normalization-recovered-diagnostics-00-terminal-acceptance.json` and `normalization-recovered-diagnostics-01-terminal-acceptance.json`.
